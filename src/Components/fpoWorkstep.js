            ...
            <section id="apmcPartners" className="py-0 bg-white pb-5">
                <div className="container mx-auto px-4 text-xs">
                    ...
                    <div className="py-0">
                        ...
                        <div className="overflow-x-auto [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden sm:overflow-hidden">
                                ...
                                <div className="w-80 sm:w-auto bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow p-6">
                                    <div className="flex items-start space-x-4">
                                        <div className="w-16 h-16 bg-green-100 rounded-lg flex items-center justify-center flex-shrink-0">
                                            <FaStore size={20} className="text-green-600" />
                                        </div>
                                        <div>
                                            ...
                                            <div className="flex items-center text-gray-500 space-x-4">
                                                <span className="flex items-center">
                                                    <FaLocationDot size={20} className="mr-2 text-green-600" />
                                                    Bengaluru
                                                </span>
                                                <span className="flex items-center">
                                                    <FaHandshakeSimple size={20} className="mr-2 text-green-600" />
                                                    150+ Vendors
                                                </span>
                                            </div>
                                        </div>
                    ...
                    <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div className="text-center">
                            <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-2">
                                <FaUsers size={20} className="text-green-600" />
                            </div>
                        ...
                        <div className="text-center">
                            <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-2">
                                <FaTruckFast size={20} className="text-green-600" />
                            </div>
                            <h4 className="font-semibold text-gray-800">
                                Direct Supply
                            </h4>
                        ...
                        <div className="text-center">
                            <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-2">
                                <MdOutlineCurrencyRupee size={20} className="text-green-600" />
                            </div>
                            <h4 className="font-semibold text-gray-800">
                                Fair Pricing
                            </h4>
